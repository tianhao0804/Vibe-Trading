...
def test_wrapped_robinhood_position_average_buy_price_parses_exposure() -> None:
    mandate = _mandate(
        account_funding_usd=300.0,
        max_order_notional_usd=230.0,
        max_total_exposure_usd=230.0,
    ...
    assert _check(
        _intent(symbol="SPCX", side="sell", notional_usd=208.57),
        mandate,
        positions=positions,
    ) is None
