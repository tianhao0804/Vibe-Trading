...
ROBINHOOD_MCP_SERVER_SEED: dict[str, object] = {
    ...
    # hiding the real read tool. Current Robinhood Agentic MCP read catalog:
    # get_accounts, get_portfolio, get_equity_positions, get_equity_orders,
    # get_equity_quotes. WRITE tools (place_equity_order, cancel_equity_order)
    # are never seeded — the user adds those by hand once a mandate exists.
    "enabled_tools": [
        "get_accounts",
        "get_portfolio",
